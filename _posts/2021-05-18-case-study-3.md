...
Subscription based businesses are super popular and Danny realised that there was a large gap in the market (and also because he loves food) - he wanted to create a new streaming service that only had food related content - think Netflix but with only cooking and dining shows!
...
When customers churn - they will keep their access until the end of their current billing period but the `start_date` will be technically the day the decided to cancel their service.
...
<iframe src="https://embed.db-fiddle.com/ab8841ff-01ac-4f5b-9f84-1ba2bf6043dc"></iframe>
</div>
